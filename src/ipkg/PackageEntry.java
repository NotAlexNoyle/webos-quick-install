        ...
        if(source != null) {
            ...
            if(source.has("Location")) {
                ...
                try {
                	...
                	System.out.println("ERROR: OnlineFile requested not found.");
        ...
        if(source != null) {
            ...
            if(source.has("LastUpdated")) {
                ...
                try {
                    ...
                    Date d = new Date(Long.parseLong(source.getString("LastUpdated")) * 1000);
                    result = DateFormat.getDateTimeInstance().format(d);
                    
                }
                catch(Exception e) {
                	
                	System.out.println("ERROR: Date format invalid.");
