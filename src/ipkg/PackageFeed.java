...
public class PackageFeed {
    ...
    private void scan() {
        ...
        try {
            ...
            if(feed.getName().toLowerCase().endsWith(".gz")) {
                ...
                input = new BufferedReader(new InputStreamReader(new GZIPInputStream(new FileInputStream(feed)), "UTF-8"));
                
            }
            else {
            	
                input = new BufferedReader(new InputStreamReader(new FileInputStream(feed), "UTF-8"));
                    ...
                    while(! line.equals("")) {
                        ...
                        if(! line.endsWith(":")) {
                            ...
                            if(line.startsWith("Package")) {
                                ...
                                curr.developer = line.substring(line.indexOf(":") + 1).replaceAll("\\<.*?\\>", "").trim();
        ...
        if(input != null) {
            ...
            try {
            	...
            	System.out.println("ERROR: Input could not be closed.");
    ...
    public static PackageFeed Download(String url) {
        ...
        // Second attempt if first download failed
        if(f == null) {
