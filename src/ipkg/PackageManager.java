...
import wosqi.WebOSQuickInstallApp;
...
public class PackageManager {
    ...
    public PackageManager(DeviceInfo info, ArrayList<InstalledEntry> apps, JTextArea display) {
        ...
        if(info.os().toLowerCase().contains("luneos")) {
            ...
            defaultFeeds = new String[] {
                ...
                "https://github.com/NotAlexNoyle/WebOS-Clock-Themer/raw/master/feed/Packages.gz"
                ...
                if(curr.source != null) {
                    ...
                    if(curr.source.has("Type")) {
                        ...
                        try {
                        	...
                        	System.out.println("ERROR: Package has no type!");
            ...
            if(curr.source != null) {
                ...
                if(curr.source.has("Category")) {
                    ...
                    try {
                        ...
                        if(category.length() > 0 && ! category.toLowerCase().equals("unavailable")) {
                    	...
                    	System.out.println("ERROR: Package has invalid category!");
    ...
    public ArrayList<PackageEntry> getPackagesByCategory(String category, boolean includeInstalled) {
    ...
    private boolean okToAdd(PackageEntry item, boolean includeInstalled) {
        ...
        result &= item.arch.equals(device.arch()) || item.arch.equals("any") || item.arch.equals("all") || device.arch().startsWith(item.arch);
        if(result && item.source != null) {
            ...
            if(item.source.has("DeviceCompatibility")) {
                ...
                try {
                	...
                	System.out.println("ERROR: Device compatibility could not be determined.");
            ...
            if(result && item.source.has("MaxWebOSVersion")) {
                ...
                try {
                	...
                	System.out.println("ERROR: WebOS version parsing failed.");
            ...
            if(result && item.source.has("Category")) {
                ...
                try {
                	...
                	System.out.println("ERROR: Category availability could not be determined.");
