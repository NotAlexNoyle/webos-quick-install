...
public class DeviceManagement extends javax.swing.JDialog {
    ...
    private void loadDeviceDetails() {
        ...
        else if(info.model().equals(DeviceInfo.Model.Palm_Pixi.toString()) || info.model().equals(DeviceInfo.Model.Palm_Pixi_Plus.toString())) {
        	
            imgURL = getClass().getResource("/resources/Palm Pixi 64x64.png");
            
        }
        else if(info.model().equals(DeviceInfo.Model.Palm_Pre.toString()) || info.model().equals(DeviceInfo.Model.Palm_Pre_Plus.toString())) {
        ...
        else if(info.model().equals(DeviceInfo.Model.Samsung_Galaxy_Nexus.toString()) || info.model().equals(DeviceInfo.Model.LG_Nexus_4.toString()) || info.model().equals(DeviceInfo.Model.Asus_Nexus_7.toString())) {
           
        	imgURL = getClass().getResource("/resources/LuneOS 64x64.png");
        	
        }
        // Unknown/Generic WebOS Device
        else {
        ...
        if(! info.model().equals(DeviceInfo.Model.Emulator.toString())) {
            ...
            try {
                ...
                String out = webOS.runProgram("/bin/grep", new String[] {"-e", "Processor", "-e", "BogoMIPS", "-e", "Hardware", "/proc/cpuinfo"});
                String[] tokens = out.split("\n");
                for(int i = 0; i < tokens.length; i++) {
                	
                    if(tokens[i].startsWith("Processor")) {
                    	
                        jLabel3.setText(bundle.getString("CPU_TYPE:") + "    " + tokens[i].substring(tokens[i].indexOf(":") + 2));
                        
                    }
                    else if(tokens[i].startsWith("BogoMIPS")) {
                    	
                        jLabel9.setText(bundle.getString("CPU_SPEED:") + "    " + tokens[i].substring(tokens[i].indexOf(":") + 2) + " MHz");
                        
                    }
                    else if(tokens[i].startsWith("Hardware")) {
                    	
                        jLabel8.setText(bundle.getString("CPU_HARDWARE:") + "    " + tokens[i].substring(tokens[i].indexOf(":") + 2));
            ...
            try {
                ...
                String[] tokens = out.split("\n");
                jLabel12.setText(bundle.getString("MODEM_TYPE:") + "    " + tokens[0].substring(tokens[0].indexOf("=") + 1));
                jLabel13.setText(bundle.getString("MODEM_FIRMWARE:") + "    " + tokens[1].substring(tokens[1].indexOf("=") + 1));
    ...
    private void loadPackages() {
                        ...
                        if(apps != null) {
                            ...
                            if(json != null) {
                                ...
                                try {
                                	...
                                	System.out.println("Could not set app info.");
        ...
        for(int i = 0; i < pkgs.size(); i++) {
            ...
            InstalledEntry curr = pkgs.get(i);
            if((jComboBox1.getSelectedIndex() == 1) == (curr.getId().startsWith("ca.canuckcoding.patches.") || curr.getId().startsWith("ca.canucksoftware.patches.") || curr.getId().startsWith("org.webosinternals.patches."))) {
    ...
    private JSONArray getApps() {
        ...
        try {
            ...
            String out = webOS.runProgram("/usr/bin/luna-send", new String[] {"-n", "1", "palm://com.palm.applicationManager/listApps", "{}"});
        ...
        for(int i = 0; i < modTable.getRowCount(); i++) {
            ...
            if(modTable.getValueAt(i, 1) == Boolean.TRUE) {
                ...
                if(warn.size() > 0) {
                    ...
                    String warnMsg = "<html><body width=\"300px\">" + MessageFormat.format(bundle.getString("DEPENDANT_PACKAGES_EXIST_WARNING"), new Object[] {modTable.getValueAt(i, 0)}) + "\n";
                    ...
                    if(JOptionPane.showConfirmDialog(rootPane, warnMsg, bundle.getString("WARNING"), JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE)==JOptionPane.OK_OPTION) {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("MainView.jMenuItem5.text"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        ...
        jLayeredPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("DeviceManagement.jLayeredPane3.border.title")));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(new Object [][] {}, new String [] {"Name", ""}) {
        ...
        jTable1.getColumnModel().getColumn(0).setHeaderValue(bundle.getString("DeviceManagement.jTable1.columnModel.title0"));
        jTable1.getColumnModel().getColumn(1).setResizable(false);
        jTable1.getColumnModel().getColumn(1).setPreferredWidth(50);
        jTable1.getColumnModel().getColumn(1).setHeaderValue(bundle.getString("DeviceManagement.jTable1.columnModel.title1"));
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wosqi.WebOSQuickInstallApp.class).getContext().getActionMap(DeviceManagement.class, this);
        jButton1.setAction(actionMap.get("uninstall"));
        jButton1.setText(bundle.getString("DeviceManagement.jButton1.text"));
        ...
        jLayeredPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("DeviceManagement.jLayeredPane2.border.title")));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLayeredPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 619, javax.swing.GroupLayout.PREFERRED_SIZE));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLayeredPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 385, javax.swing.GroupLayout.PREFERRED_SIZE));
        ...
        if(i > -1) {
            ...
            if(jTable1.columnAtPoint(evt.getPoint()) == 0) {
                ...
                if(jComboBox1.getSelectedIndex() == 0) {
                    ...
                    InstalledPkgInfo info = new InstalledPkgInfo(mainFrame, webOS, filtered.get(i));
                    ...
                    InstalledPatchInfo info = new InstalledPatchInfo(mainFrame, webOS, filtered.get(i));
                    info.setLocationRelativeTo(mainFrame);
                    WebOSQuickInstallApp.getApplication().show(info);
